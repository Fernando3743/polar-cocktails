...
/** Delivery scooter glyph (Material Icons) matched to the Polar prototype. */
export function ScooterIcon({ className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M6 6h3c.55 0 1 .45 1 1s-.45 1-1 1H6c-.55 0-1-.45-1-1s.45-1 1-1m13 7c-1.66 0-3 1.34-3 3s1.34 3 3 3s3-1.34 3-3s-1.34-3-3-3m0 4c-.55 0-1-.45-1-1s.45-1 1-1s1 .45 1 1s-.45 1-1 1" />
    </svg>
  );
}
